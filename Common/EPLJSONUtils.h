...
/*
	//! Get string by name in argument, returns false if name is not found, or its format is invalid
	static bool GetStringByName(const json& inJSON, const std::string& inName, std::string* rValue)
	{
		// Check desired value exists
		json::const_iterator iter(inJSON.find(inName));
		if (iter == inJSON.end())
...
*/
	...
	/*
	//! Get bool by name in argument, returns false if name is not found, or its format is invalid
	static bool GetBoolByName(const json& inJSON, const std::string& inName, bool* rValue)
	{
		// Check desired value exists
		json::const_iterator iter(inJSON.find(inName));
		if (iter == inJSON.end())
	...
	*/
	...
	/*
	//! Get integer by name in argument, returns false if name is not found, or its format is invalid
	static bool GetIntByName(const json& inJSON, const std::string& inName, int* rValue)
	{
		// Check desired value exists
		json::const_iterator iter(inJSON.find(inName));
		if (iter == inJSON.end())
	...
	*/
	...
	/*
	//! Get unsigned integer by name in argument, returns false if name is not found, or its format is invalid
	static bool GetUnsignedIntByName(const json& inJSON, const std::string& inName, unsigned int *rValue)
	{
		// Check desired value exists
		json::const_iterator iter(inJSON.find(inName));
		if (iter == inJSON.end())
	...
	*/
	...
	//! Get float by name in argument, returns false if name is not found, or its format is invalid
	static bool GetFloatByName(const json& inJSON, const std::string& inName, float* rValue)
	{
		// Check desired value exists
		json::const_iterator iter(inJSON.find(inName));
		if (iter == inJSON.end())
